...
5. Khi wizard hỏi cookies, paste nguyên đoạn JSON đó. Type `OK` rồi Enter để kết thúc.
...
### Wizard nhận 2 format(Wizard accepts 2 formats):
...
**Format 2 — Object ngắn gọn (Object is concise):**
```json
...
4. Paste into the wizard when prompted. End with `OK` on a new line.
